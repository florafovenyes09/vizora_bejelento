package com.example.vizora_bejelento;
...
public class fooldalActivity extends AppCompatActivity {
    ...
    private ArrayList<VizoraItem> mItemsData;
    private VizoraItemAdapter mAdapter;
...
/*        preferences = getSharedPreferences(PREF_KEY, MODE_PRIVATE);
        ...
        mAdapter = new VizoraItemAdapter(this, mItemsData);
    ...
    private void initializeData() {
        ...
        for (int i = 0; i < itemsList.length; i++) {
            mItemsData.add(new VizoraItem(itemsList[i], itemsInfo[i], itemsPrice[i], itemRate.getFloat(i, 0),
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.vizora_menu, menu);
